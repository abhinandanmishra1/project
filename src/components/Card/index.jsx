...
export default function Card({ title, description }) {
  return (
    <div className="flex flex-col bg-custom-darkblue rounded-xl text-white hover:shadow-custom w-[270px] md:w-[320px] lg:w-[350px]">
      <div className="h-[24px] border-b-[3px] border-custom-link"></div>
      <div className="flex flex-col p-4 gap-[10px]">
        <p className="text-lg md:text-[22px] h-32">{description}</p>
